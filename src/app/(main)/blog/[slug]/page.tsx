...
// hero bölümü hiç render edilmiyor.
    ...
    <>
      ...
      <div className="m-wrap" style={{ paddingTop: 28, paddingBottom: 64 }}>
        ...
        <div className="m-blog-layout">
          <article>
            {post.coverImage && (
              <div style={{ borderRadius: 'var(--radius)', overflow: 'hidden', height: 320, marginBottom: 32, border: '1px solid var(--line-soft)', background: 'var(--bg-2)' }}>
              ...
              <div className="m-surface" style={{ padding: '20px 22px', marginBottom: 20 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                  {relatedPosts.map((p: any) => (
                    <Link key={p.slug} href={`/blog/${p.slug}`} style={{ textDecoration: 'none', display: 'flex', flexDirection: 'column', gap: 4, paddingBottom: 12, borderBottom: '1px solid var(--line-soft)' }}>
